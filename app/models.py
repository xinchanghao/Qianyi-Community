...
class User(models.Model):
	...
	user_photo= models.CharField(u'头像',max_length=256,null=True,default="project-2.jpg")
	user_descripe= models.CharField(u'描述',max_length=256,null=True,default="尚未更新...")
	user_password =models.CharField(u'瀵嗙爜',max_length=16)
	user_email =models.EmailField(u'閭',max_length=30)
	user_sex =models.TextField(u'鎬у埆',max_length=5,null=True,default="尚未更新...")
	user_addr =models.CharField(u'绠�浠�',max_length=256,null=True,default="尚未更新...")
	user_birth =models.DateTimeField(u'鍑虹敓骞存湀',editable=True,null=True,auto_now_add=True)
	user_sign=models.CharField(u'签名',max_length=256,null=True,default="尚未更新...")
	user_intro=models.CharField(u'介绍',max_length=512,null=True,default="尚未更新...")
